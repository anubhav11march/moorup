        ...
        <>
         ...
         <div className="mainT">
             ...
             <div className="body-2T">
                 <h2>Meet the Team</h2>
                 <p>We are highly experienced global team from telecon and consulting sector, giving the assurance we are trusted partner to rely on</p>
             </div>
             <div className="body-3T">
                 ...
                 <div className="Main-colT">
                     ...
                     <div className="subBodyT">
                         ...
                         <p style={{color:"teal"}}>Co-Founder & CEO </p>
